...
- If the source string contains characters like
&
or…
, the translated string should contain them as well.
...
.
New strings should be added only in the en.json
file.
Strings in other languages will be synced through crowdin and should not be added directly as a PR/commit in the frontend repo.
