...
Custom errors usually have fields for the http return code, a Vikunja-specific error code and a human-readable error message about what went wrong.
...
// Your error type is \_required\_ to implement this in order to be able to be returned as an "error" from functions.
...
// \* Every "group" of errors lives in a thousand something. For example all user issues are 1000-something, all
