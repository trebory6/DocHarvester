...
To add a new table to the database, create the struct and add a migration for it.
To learn more about how to configure your struct to create “good” tables, refer to the xorm documentation.
...
> **Note**: Table and column names need to be in snake\_case as that’s what is used internally in the database and for mapping values from the database to xorm so your structs can use it.
